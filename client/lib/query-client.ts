...
/**
 * The fixed production BASE_URL for the Railway Web Service.
 ...
 * In development (Replit), uses the environment variable.
 * In production (APK), uses the hardcoded BASE_URL.
